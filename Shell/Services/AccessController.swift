...
final class AccessController {
    ...
    static func resolveDecision(
        ...
        switch mode {
        case .free, .ads, .adsWithRemovePurchase, .adsWithSubscription, .creationCapWithSubscription:
            .allowed
    ...
    var remainingFreeActions: Int? {
        ...
        case .usageCapWithOneTimeUnlock, .usageCapWithSubscription, .creationCapWithSubscription:
            usage.remaining
        default:
            nil
        }
